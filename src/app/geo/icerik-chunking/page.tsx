...
const jsonLd = JSON.stringify({
    ...
    "@graph": [
        {
            "@type": "Article",
            "@id": "https://bahattinyaylagul.com/geo/icerik-chunking#article",
            "headline": "İçerik Chunking: AI Sistemleri Bir Sayfanın Neresinden Alıntı Yapar?",
            ...
            "url": "https://bahattinyaylagul.com/geo/icerik-chunking",
            "mainEntityOfPage": {
                "@type": "WebPage",
                "@id": "https://bahattinyaylagul.com/geo/icerik-chunking"
            },
        ...
        },
        {
            ...
            "itemListElement": [
                ...
                { "@type": "ListItem", "position": 3, "name": "İçerik Chunking", "item": "https://bahattinyaylagul.com/geo/icerik-chunking" }
            ]
        },
        {
            "@type": "FAQPage",
            "mainEntity": [
                {
                                "@type": "Question",
                                "name": "Chunk boyutu ne olmalı?",
                                "acceptedAnswer": {
                                                "@type": "Answer",
                                                "text": "Soru-cevap retrieval'ı için 256–512 token aralığı genel olarak en iyi performansı veriyor. Türkçe metinde bunun pratik karşılığı yaklaşık 50–120 kelime."
                                }
                },
                {
                                "@type": "Question",
                                "name": "Türkçe içerikte pasajı neden daha kısa tutmak gerekiyor?",
                                "acceptedAnswer": {
                                                "@type": "Answer",
                                                "text": "Çünkü Türkçe sondan eklemeli bir dil ve dil modellerinin kullandığı alt-kelime sözlükleri ağırlıklı olarak İngilizce metinle oluşturuldu. Türkçe kelimelerdeki ek zincirleri birden fazla parçaya bölünüyor, dolayısıyla aynı anlam daha fazla token harcıyor. Token bütçesi sabit olduğu için Türkçe pasaj, aynı bilgiyi taşıyan İngilizce pasajdan daha az kelime içerebiliyor. Kesin oran tokenizer'a göre değişir; kendi modelinizin tokenizer'ıyla ölçmek en doğrusu."
                                }
                },
                {
                                "@type": "Question",
                                "name": "Overlap (örtüşme) şart mı?",
                                "acceptedAnswer": {
                                                "@type": "Answer",
                                                "text": "Hayır. Ocak 2026'da yayımlanan sistematik bir analiz, chunk overlap'in test edilen kurulumda ölçülebilir fayda sağlamadığını, buna karşın indeksleme maliyetini artırdığını buldu. Bulgu tek bir kurulumda elde edildi; her mimari için genel kural sayılmamalı."
                                }
                },
                {
                                "@type": "Question",
                                "name": "Chunking, SEO'nun yerini alır mı?",
                                "acceptedAnswer": {
                                                "@type": "Answer",
                                                "text": "Almaz. Güçlü bir bağlantı profili ve teknik SEO temelleri hâlâ gerekli. İçerik chunking, iyi yazarlığa dair formatlama ilkelerinin başka bir adı sayılabilir."
                                }
                },
                {
                                "@type": "Question",
                                "name": "Uzun makale yazmak hâlâ işe yarar mı?",
                                "acceptedAnswer": {
                                                "@type": "Answer",
                                                "text": "Yarar, ama mantığı değişti. Uzun içeriğin ortasında kalan bilgiler \"lost-in-the-middle\" sorunuyla gözden kaçabiliyor. Uzunluk kendi başına ne avantaj ne dezavantaj; belirleyici olan metnin kaç tane kendi başına anlaşılır pasaja bölünebildiği."
                                }
                },
                {
                                "@type": "Question",
                                "name": "AI atfı için alan adı otoritesi yeterli mi?",
                                "acceptedAnswer": {
                                                "@type": "Answer",
                                                "text": "Tek başına değil. Ölçümler içerik kalitesinin yapay zeka yanıtlarındaki sıralamayı chunking'den daha fazla etkilediğini, buna karşılık yalnızca başka kaynakları yeniden ifade eden içeriğin daha az atıf aldığını gösteriyor."
                                }
                },
                {
                                "@type": "Question",
                                "name": "Yanlış chunking ne kadar fark yaratır?",
                                "acceptedAnswer": {
                                                "@type": "Answer",
                                                "text": "Aynı corpus ve aynı retriever kullanılsa bile en iyi ile en kötü chunking yöntemi arasında %9'a varan recall farkı ölçüldü. Anthropic'in Contextual Retrieval deneyinde ise retrieval başarısızlıkları %5,7'den %1,9'a düştü — bu ikinci sayı satıcının kendi test kurulumundan geliyor."
                                }
                }
]
        }
        ...
        <main className="min-h-screen bg-white font-sans selection:bg-violet-100 selection:text-violet-900">
            ...
            <header className="w-full bg-gray-900 pt-16 pb-0 relative overflow-hidden mt-20">
                <div className="absolute inset-0 z-0">
                    <Image
                        ...
                        alt="İçerik Chunking: AI Sistemleri Bir Sayfanın Neresinden Alıntı Yapar?"
                        fill
                        ...
                        <div className="space-y-8 flex flex-col justify-center h-full pb-16 pt-12">
                            <div>
                                ...
                                <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-white leading-[1.1] tracking-tight mb-6">
                                    İçerik Chunking: AI Sistemleri Bir Sayfanın Neresinden Alıntı Yapar?
                                </h1>

                                <p className="lead-text text-gray-300 text-lg leading-relaxed font-medium max-w-xl mb-8">
                                    İçerik chunking, metni yapay zeka sistemlerinin tek başına işleyebileceği pasajlara bölme tekniğidir. Pasaj boyutu, Türkçe tokenizasyon farkı, alıntılanabilir pasaj yazımı, RAG retrieval hattı ve chunking denetimi.
                                </p>
            ...
            <div className="max-w-[1400px] mx-auto px-6 md:px-8 pt-12 pb-20">
                <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-xs text-gray-400 mb-8 font-medium tracking-wide font-sans">
                    ...
                    <span className="text-gray-200">/</span>
                    <span className="text-gray-600 font-bold truncate">İçerik Chunking</span>
                </nav>

                <ArticleContent />
            </div>

            <ArticleFooter currentSlug="icerik-chunking" />
            <Footer />
        </main>
    );
}
