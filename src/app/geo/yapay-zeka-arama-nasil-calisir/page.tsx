    ...
    "@graph": [
        {
            ...
            "mainEntityOfPage": {
                "@type": "WebPage",
                "@id": "https://bahattinyaylagul.com/geo/yapay-zeka-arama-nasil-calisir"
            },
        ...
        },
        {
            ...
            "itemListElement": [
                ...
                { "@type": "ListItem", "position": 3, "name": "Yapay Zeka Araması Nasıl Çalışır? RAG ve Grounding Rehberi", "item": "https://bahattinyaylagul.com/geo/yapay-zeka-arama-nasil-calisir" }
            ]
        },
        {
            "@type": "FAQPage",
            "mainEntity": [
                {
                                "@type": "Question",
                                "name": "RAG ile fine-tuning arasındaki fark nedir?",
                                "acceptedAnswer": {
                                                "@type": "Answer",
                                                "text": "RAG yeni bilgiyi modele çalışma anında, istemin içinde sunar; fine-tuning ise modelin ağırlıklarını yeni veriyle yeniden eğitir. Bilgi sık değişiyorsa RAG genelde daha pratik ve daha ucuz bir yol, çünkü modeli yeniden eğitmeden veri eklenebiliyor. Fine-tuning ise davranış ve üslup değiştirmek istediğinizde devreye giriyor. İkisi rakip değil, farklı işlerin araçları."
                                }
                },
                {
                                "@type": "Question",
                                "name": "Grounding halüsinasyonu tamamen önler mi?",
                                "acceptedAnswer": {
                                                "@type": "Answer",
                                                "text": "Hayır. Modele istem içinde gerçek belgeler vermek uydurma oranını düşürür, ama iyi temellendirilmiş modeller bile aldıkları içeriği yanlış aktarabilir."
                                }
                },
                {
                                "@type": "Question",
                                "name": "İçeriğim modelin eğitim verisinde yoksa hiç şansım yok mu?",
                                "acceptedAnswer": {
                                                "@type": "Answer",
                                                "text": "Tam tersi. RAG'ın varlık sebebi bu: cevap eğitim verisinden değil, o an getirilen belgelerden kuruluyor. Dün yayımladığınız bir sayfa, bugün sorulan bir soruya kaynak olabilir. Bu yüzden tazelik ve taranabilirlik, modelin sizi tanıyor olmasından daha belirleyici."
                                }
                },
                {
                                "@type": "Question",
                                "name": "Neden içeriğim getiriliyor ama atıf almıyorum?",
                                "acceptedAnswer": {
                                                "@type": "Answer",
                                                "text": "İki ayrı ihtimal var. Ya yeniden sıralama adımında elendiniz — getirildiniz ama daha alakalı bulunan başka pasajlar üste çıktı. Ya da kaynak bilgisi net izlenemediği için sistem içeriği kullandı ama size referans veremedi. Birincisinin çaresi ayrışma, ikincisinin çaresi yazar, tarih ve kurum bağını makine tarafında net kurmak."
                                }
                },
                {
                                "@type": "Question",
                                "name": "Tek adımlı RAG mı, agentic retrieval mı?",
                                "acceptedAnswer": {
                                                "@type": "Answer",
                                                "text": "Basit arama görevlerinin çoğu için tek adımlı RAG yeterli. Çok adımlı akıl yürütme gerektiren, birden çok kaynağı birleştirmesi gereken sorularda agentic retrieval devreye giriyor. İçerik tarafında bunun anlamı, karşılaştırma ve karar sorularının tek bir sayfayla değil, birbirine bağlı bir sayfa kümesiyle kazanıldığı. Alt sorular paralel yürütüldüğü için, o kümenin her parçasında ayrı ayrı görünür olmanız gerekiyor."
                                }
                },
                {
                                "@type": "Question",
                                "name": "Verilerimin gizliliği RAG'da nasıl korunur?",
                                "acceptedAnswer": {
                                                "@type": "Answer",
                                                "text": "Tamamen mimariye ve araç seçimine bağlı. Kendi altyapınızda çalışan bir arama katmanı kurduğunuzda verinin dışarı çıkmaması mümkün — Elasticsearch üzerine kurulan RAG için üretici bunu açıkça belirtiyor; satıcı beyanı olduğunu not edelim. Harici bir API'ye bağlanan kurulumlarda ise sözleşme ve veri işleme koşulları belirleyici oluyor."
                                }
                }
]
        }
        ...
        <main className="min-h-screen bg-white font-sans selection:bg-violet-100 selection:text-violet-900">
            ...
            <header className="w-full bg-gray-900 pt-16 pb-0 relative overflow-hidden mt-20">
                <div className="absolute inset-0 z-0">
                    <Image
                        ...
                        alt="Yapay Zeka Araması Nasıl Çalışır? RAG ve Grounding Rehberi"
                        fill
            ...
            <div className="max-w-[1400px] mx-auto px-6 md:px-8 pt-12 pb-20">
                <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-xs text-gray-400 mb-8 font-medium tracking-wide font-sans">
                    ...
                    <span className="text-gray-200">/</span>
                    <span className="text-gray-600 font-bold truncate">Yapay Zeka Araması Nasıl Çalışır? RAG ve Grounding Rehberi</span>
                </nav>

                <ArticleContent />
            </div>

            <ArticleFooter currentSlug="yapay-zeka-arama-nasil-calisir" />
            <Footer />
        </main>
    );
}
