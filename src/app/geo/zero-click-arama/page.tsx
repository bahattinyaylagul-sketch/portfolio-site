...
const jsonLd = JSON.stringify({
    ...
    "@graph": [
        {
            "@type": "Article",
            "@id": "https://bahattinyaylagul.com/geo/zero-click-arama#article",
            "headline": "Zero-Click Arama: 2026 Verileri, Gerçek Etkisi ve Ne Yapmalı",
            ...
            "url": "https://bahattinyaylagul.com/geo/zero-click-arama",
            "mainEntityOfPage": {
                "@type": "WebPage",
                "@id": "https://bahattinyaylagul.com/geo/zero-click-arama"
            },
        ...
        },
        {
            ...
            "itemListElement": [
                ...
                { "@type": "ListItem", "position": 3, "name": "Zero-Click Arama", "item": "https://bahattinyaylagul.com/geo/zero-click-arama" }
            ]
        },
        {
            "@type": "FAQPage",
            "mainEntity": [
                {
                                "@type": "Question",
                                "name": "Search Console'da zero-click etkisini nasıl anlarım?",
                                "acceptedAnswer": {
                                                "@type": "Answer",
                                                "text": "Gösterim sayısı sabit kalırken tıklamaların düşmesi klasik belirtidir. Sorgu bazında bakın: aynı ortalama pozisyonda durup CTR'si eriyen sorgular, üstünde bir yanıt yüzeyi belirmiş olma ihtimali yüksek olanlardır. Tek bir sorguya değil, sorgu kümesine bakmak gerekir; tekil dalgalanma gürültü olabilir."
                                }
                },
                {
                                "@type": "Question",
                                "name": "Zero-click oranı 2028'e kadar nereye gider?",
                                "acceptedAnswer": {
                                                "@type": "Answer",
                                                "text": "Yaygın öngörü %68–72 bandı ve organik tıklamalarda 2024'e kıyasla %25 azalma. Bunun ölçülmüş bir veri değil, mevcut eğrinin uzatılmasıyla üretilmiş bir tahmin olduğunu belirtmek gerekiyor; Google'ın reklam gelirini koruma refleksi tek başına bu eğriyi büküyor."
                                }
                },
                {
                                "@type": "Question",
                                "name": "Pazarlamacıların kaçı yapay zeka görünürlüğünü ölçüyor?",
                                "acceptedAnswer": {
                                                "@type": "Answer",
                                                "text": "Yalnızca %14'ü AI Bakışı gösterim payını ve atıf sıklığını takip ediyor (Goodfirms, 2026). Rekabet avantajının nerede olduğunu gösteren rakam bu."
                                }
                },
                {
                                "@type": "Question",
                                "name": "ChatGPT atıfları için Bing indeksi neden önemli?",
                                "acceptedAnswer": {
                                                "@type": "Answer",
                                                "text": "ChatGPT'nin verdiği atıfların %87'si Bing'in üst sonuçlarından geliyor. Google'da iyi sıralanıp Bing'de indekslenmemek, ChatGPT görünürlüğünü tek başına sıfırlayabilir."
                                }
                },
                {
                                "@type": "Question",
                                "name": "GEO'nun geleneksel SEO'dan farkı ne?",
                                "acceptedAnswer": {
                                                "@type": "Answer",
                                                "text": "GEO, sonuç listesinde sıralanmak yerine yapay zeka yanıtlarında kaynak olarak gösterilmeyi hedefler. Optimize edilen şey sayfa değil, sayfanın modele sunduğu doğrulanabilir bilgi parçası. Sık aktarılan bir iddiaya göre LLM kaynaklarının %58'i Reddit, Quora ve forum içeriklerinden geliyor — bu rakam tek bir kaynağa dayanıyor ve bağımsız doğrulaması yok, yön göstergesi olarak alın."
                                }
                },
                {
                                "@type": "Question",
                                "name": "nosnippet etiketini kullanmalı mıyım?",
                                "acceptedAnswer": {
                                                "@type": "Answer",
                                                "text": "Çoğu site için hayır. Özetlenmeyi engeller ama öne çıkan snippet ve zengin sonuç görünürlüğünü de birlikte götürür."
                                }
                },
                {
                                "@type": "Question",
                                "name": "Öne çıkan snippet, AI Bakışı varken ne kadar değer kaybediyor?",
                                "acceptedAnswer": {
                                                "@type": "Answer",
                                                "text": "AI Bakışı yokken öne çıkan snippet'ın CTR'si %42,2; AI Bakışı ile birlikte göründüğünde %23,8'e iniyor. Göreli düşüş %43,6. Snippet'ı kaybetmiyorsunuz, üstüne bir katman biniyor."
                                }
                },
                {
                                "@type": "Question",
                                "name": "Türkiye'deki siteler bu rakamlara göre plan yapabilir mi?",
                                "acceptedAnswer": {
                                                "@type": "Answer",
                                                "text": "Yönü için evet, seviyesi için hayır. AI Bakışı ve AI Modu Türkiye'de 18 Şubat 2026'da açıldığı için tetiklenme sıklığı ve tıklama kaybı ABD seviyesinde değil. Doğru yaklaşım, o tarihi kırılma noktası kabul edip Search Console'da kendi öncesi–sonrası karşılaştırmanızı çıkarmak."
                                }
                }
]
        }
        ...
        <main className="min-h-screen bg-white font-sans selection:bg-violet-100 selection:text-violet-900">
            ...
            <header className="w-full bg-gray-900 pt-16 pb-0 relative overflow-hidden mt-20">
                <div className="absolute inset-0 z-0">
                    <Image
                        ...
                        alt="Zero-Click Arama: 2026 Verileri, Gerçek Etkisi ve Ne Yapmalı"
                        fill
            ...
            <div className="max-w-[1400px] mx-auto px-6 md:px-8 pt-12 pb-20">
                <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-xs text-gray-400 mb-8 font-medium tracking-wide font-sans">
                    ...
                    <span className="text-gray-200">/</span>
                    <span className="text-gray-600 font-bold truncate">Zero-Click Arama</span>
                </nav>

                <ArticleContent />
            </div>

            <ArticleFooter currentSlug="zero-click-arama" />
            <Footer />
        </main>
    );
}
