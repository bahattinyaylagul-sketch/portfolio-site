    ...
    return (
        <section id="geo-kanit" className="max-w-6xl mx-auto px-4 md:px-6 scroll-mt-32">
            <div className="mb-10 text-center">
                ...
                <h2 className="text-3xl md:text-4xl font-black text-gray-900 mb-4 tracking-tight">AI Visibility Score</h2>
                <p className="text-gray-600 max-w-2xl mx-auto text-[15px] leading-relaxed">
                    ChatGPT, Gemini, Google AI Overview ve AI Mode görünürlüğünü zaman içinde takip ediyoruz.
                </p>
            </div>
            ...
            <div className="space-y-8">
                ...
                {/* Yan Yana İki Kart Yerine Alt Alta Tam Genişlik (Okunabilirlik İçin) */}
                <div className="space-y-8">
                    {/* Google AI Overview */}
                    ...
                    <div className="bg-white rounded-3xl border border-gray-100 shadow-[0_4px_20px_-10px_rgba(0,0,0,0.05)] overflow-hidden flex flex-col">
                        <div className="p-6 md:p-8 border-b border-gray-50 bg-gray-50/50">
                            <h3 className="text-xl font-bold text-gray-900 flex items-center gap-2">
                                <svg className="w-6 h-6 text-purple-500" viewBox="0 0 24 24" fill="currentColor"><path d="M19.74 7.33l-2.06-2.06a2.02 2.02 0 00-2.83 0L13.4 6.7c-.77.77-2.03.77-2.8 0L9.15 5.27a2.02 2.02 0 00-2.83 0L4.26 7.33a2.02 2.02 0 000 2.83l1.45 1.45c.77.77 2.03.77 2.8 0l1.45-1.45c.78-.77 2.04-.77 2.82 0l1.45 1.45c.77.77 2.03.77 2.8 0l1.45-1.45a2.02 2.02 0 000-2.83zM12 17.5l-4-4v-2l4 4 4-4v2l-4 4z"/></svg>
                                Google Gemini
                            </h3>
