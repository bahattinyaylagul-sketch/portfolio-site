...
const headings = [
    { id: "turkiye-lansmani", text: "AI Modu Türkiye'de ne zaman açıldı?" },
    { id: "ai-modu-nedir", text: "Google AI Modu nedir ve farkı ne?" },
    { id: "ai-modu-ai-bakisi-farki", text: "AI Modu ile AI Bakışı arasındaki fark ne?" },
    { id: "fan-out", text: "Fan-out mekaniği" },
    { id: "optimizasyon", text: "AI Modu'nda kaynak olmak için ne yapmalısınız?" },
    { id: "turkce-firsat", text: "Türkçe sorgularda rekabet neden bu kadar seyrek?" },
    { id: "test", text: "Görünürlüğünüzü nasıl test edersiniz?" },
    { id: "kpi", text: "Trafik düşerken gelir artabilir mi?" },
        ...
        <div className="grid lg:grid-cols-[250px_1fr] gap-12 items-start relative">
            ...
            <article className="min-w-0 geo-rehber">
                ...
                <aside className="tldr mb-12 p-6 md:p-8 bg-violet-50/50 border border-violet-100/80 rounded-3xl shadow-sm">
                    ...
                    <p className="text-gray-800 font-bold text-[15px] leading-relaxed mb-4">AI Modu Türkiye&apos;de 18 Şubat 2026&apos;da açıldı ve Türkçe içerik arzı bu yüzeye hazır değil — bu, kapanmadan önce girilmesi gereken bir zaman aralığı.</p>
                    <ul className="space-y-3.5 text-gray-700 text-[15px] leading-relaxed list-none pl-0 my-0">
                        <li className="flex items-start gap-3"><span className="text-violet-600 font-bold shrink-0 mt-0.5">✦</span><span>Türkiye, AI Modu&apos;nun daha önceki 180 ülkelik açılım dalgasının dışında bırakılmıştı. Türkçe rekabet bu yüzden hâlâ ince.</span></li>
                        <li className="flex items-start gap-3"><span className="text-violet-600 font-bold shrink-0 mt-0.5">✦</span><span>AI Modu ile AI Bakışı aynı şey değil: biri ayrı bir sekme ve reklamsız, diğeri sonuç sayfasının üstünde duran bir özet bloğu.</span></li>
                        <li className="flex items-start gap-3"><span className="text-violet-600 font-bold shrink-0 mt-0.5">✦</span><span>Fan-out mekaniği yüzünden tek bir sayfa onlarca alt sorgu üzerinden değerlendiriliyor. Yüzeysel kapsam ilk elemede düşüyor.</span></li>
                        <li className="flex items-start gap-3"><span className="text-violet-600 font-bold shrink-0 mt-0.5">✦</span><span>Ölçüm tarafında tıklama sayısı tek başına yanıltıcı; oturum derinliği ve dönüşüm oranı olmadan tabloyu okuyamazsınız.</span></li>
                    </ul>
                </aside>
                ...
                <div className="prose prose-lg max-w-none 
                    ...
                    {/* kaynak: K108-F1, K111-F5, K108-F11 */}
                    <p>
                    ...
                    <table className="karsilastirma">
                        <thead><tr><th>Özellik</th><th>Geleneksel Arama</th><th>AI Bakışı (AI Overviews)</th><th>AI Modu (AI Mode)</th></tr></thead>
                        <tbody>
                            <tr><td>Arayüz</td><td>10 mavi bağlantı + SERP</td><td>SERP üstü özet kutusu</td><td>Ayrı sekme, konuşmaya dayalı</td></tr>
                            <tr><td>Organik sonuçlar</td><td>Var</td><td>Var</td><td>Yok</td></tr>
                            <tr><td>Reklam</td><td>Var</td><td>Var</td><td>Yok</td></tr>
                            <tr><td>Gösterilen kaynak sayısı</td><td>10+</td><td>Birkaç</td><td>1-3 (kalanı açılır katmanda)</td></tr>
                            <tr><td>İçerik işleme biçimi</td><td>Listeleme</td><td>Özetleme</td><td>Yorum, bağlantı kurma, çıkarım</td></tr>
                            <tr><td>Türkiye&apos;de erişim</td><td>Var</td><td>18 Şubat 2026&apos;dan itibaren</td><td>18 Şubat 2026&apos;dan itibaren</td></tr>
                        </tbody>
                    </table>
                    {/* kaynak: K111-F5, K108-F7, K108-F8, K108-F11, K112-F24 */}
                    {/* kaynak: Türkiye erişim satırı — blog.google/intl/tr-tr, 18 Şubat 2026 */}
                    <p>
                    ...
                    <p>
                        ...
                        <Link href="/geo/query-fan-out">query fan-out sayfasında</Link> ayrıca işledim.
                    </p>
                    ...
                    <p>
                        ...
                        <Link href="/geo/yapay-zeka-schema" data-pending="true">Yapay zeka için schema</Link> tarafında hangi
                        alanların gerçekten okunduğu ayrı bir konu.
                    </p>
                    {/* kaynak: K112, K111 */}
                    ...
                    <p>
                        ...
                        <Link href="/geo/entity-seo">Entity SEO</Link> çalışmasının teknik ayağı büyük ölçüde budur.
                    </p>
                    {/* kaynak: K110 */}
                    ...
                    <p>
                        <code>isAccessibleForFree</code>, <code>inLanguage</code> ve <code>contentLocation</code> etiketleri içeriğin daha hassas kategorize edilmesini
                        sağlıyor. Türkçe içerik için <code>inLanguage: &quot;tr-TR&quot;</code> ve <code>contentLocation</code> özellikle önemli, çünkü modelin Türkiye bağlamına ait bir
                    ...
                    <p>
                        ...
                        bir araç ekosistemi doğurdu: çeşitli AEO platformları ve görünürlük araçları alıntıları ve marka
                        anılmalarını izlemek üzere konumlandı. Hiçbiri Search Console&apos;un yerini tutmuyor; hepsi kendi örneklem yöntemiyle çalışıyor ve
                        ölçtükleri şey Google&apos;ın gerçek gösterim verisi değil.
                    </p>
                    {/* kaynak: K108, K110, K112 */}
                    <p>
                        ...
                        <Link href="/geo/geo-kpi-olcumu">GEO KPI ölçümü</Link> sayfasında ayrıntılandırdım.
                    </p>
                    <p>
                    ...
                    <p>Dizine eklenmiş her sayfa ek bir gereksinim olmadan AI Modu&apos;nda görünmeye uygundur. Ama uygun olmak ile alıntılanmak aynı şey değil. Uygunluk bir eşik, alıntılanma bir seçim; seçimi belirleyen şey içeriğin alt sorulara ne kadar iyi cevap verdiği ve markanın varlık olarak ne kadar net tanındığı. {/* kaynak: K112 */}</p>
                    <h3>AI Modu Türkiye&apos;de hangi cihazlarda ve hangi yüzeylerde çalışıyor?</h3>
                    <p>Google&apos;ın 18 Şubat 2026 tarihli duyurusuna göre AI Modu ve AI Bakışı, Android ve iOS için Google uygulamasında ve arama sonuçları sayfasında kademeli olarak açıldı. İkisi de Gemini 3 model ailesine dayanıyor ve metin, ses ve kamera girdisini birlikte işleyebiliyor. Kademeli açılım nedeniyle her kullanıcı aynı anda aynı deneyimi görmeyebilir.</p>
                    <h3>Googlebot-Extended ile yapay zeka eğitimini engellersem AI Modu&apos;ndaki görünürlüğüm düşer mi?</h3>
                    <p>Hayır, ikisi birbirinden bağımsız. Googlebot-Extended direktifi içeriğinizi model eğitim verisinden çıkarır, ancak AI Bakışı veya AI Modu yanıtlarında alıntılanmanızı engellemez. Bu iki kararı ayrı ayrı vermelisiniz. {/* kaynak: K111 */}</p>
                    <h3>AI Modu&apos;nda kaynak gösterilmek için birinci sırada olmak şart mı?</h3>
                    <p>Şart değil. Sistem yalnızca üst sıralardaki sayfaları değil, konuyla ilgili ve iyi yapılandırılmış alt konularda daha düşük sırada duran sayfaları da alıntılayabiliyor. Fan-out mekaniği bunu mümkün kılıyor: ana sorguda onuncu sırada olan bir sayfa, o sorgunun bölündüğü alt sorulardan birinde en iyi cevap olabilir. Küçük ve odaklı siteler için asıl fırsat burada. {/* kaynak: K111 */}</p>
                    <h3>E-ticaret siteleri AI Modu&apos;nda nasıl öne çıkar?</h3>
                    <p>Ürün odaklı sitelerde iki teknik adım öne çıkıyor. Birincisi, Google&apos;ın yapay zeka ajanlarıyla entegre çalışan rezervasyon ve bilet platformlarına bağlanmak. İkincisi, ajanların gerçek zamanlı stok ve fiyat bilgisine ulaşabilmesi için genel bir API veya yapılandırılmış ürün akışı sunmak. Stok bilgisi güncel olmayan bir katalog, ajan tabanlı alışveriş akışında baştan eleniyor. {/* kaynak: K110 */}</p>
                    <h3>Bilgilendirici sorgularda tıklama oranı ne kadar düşüyor?</h3>
                    <p>Ölçümler AI yanıtı tetikleyen sorgularda ortalama %34,5 düşüş gösteriyor, bazı sorgu türlerinde bu oran %64&apos;e çıkıyor. En sert düşüş bilgilendirici sorgularda yaşanıyor; gezinme ve işlemsel sorgular çok daha az etkileniyor. Bu veriler İngilizce sorgu setlerinden geliyor, Türkçe için doğrudan karşılığı henüz ölçülmedi. {/* kaynak: K108, K111 */}</p>
                    <h3>Uzun ve karmaşık sorgularda durum farklı mı?</h3>
                    <p>Evet ve bu bir fırsat. Uzun kuyruklu karmaşık sorgularda doğrudan tıklama azalsa bile yanıt içinde atıf alma oranı artıyor. AI Modu&apos;nun ayrı bir sekme olması da kullanıcıların oraya geçmek için bilinçli bir hareket yapmasını gerektiriyor; bu sekmeye geçen kullanıcı genellikle daha spesifik bir niyetle geliyor. {/* kaynak: K111, K108 */}</p>
                    <h3>AI Modu&apos;ndan gelen trafiği Search Console&apos;da görebilir miyim?</h3>
                    <p>Ayrıştırılmış olarak göremezsiniz. Search Console AI Bakışı ve AI Modu dokunma noktalarını raporluyor ancak veriyi kaynak yüzeyine göre filtrelemeye izin vermiyor. Üçüncü taraf görünürlük araçları bu boşluğu kendi örneklem yöntemleriyle doldurmaya çalışıyor, fakat ürettikleri sayı Google&apos;ın gerçek gösterim verisi değil, tahmindir. {/* kaynak: K108 */}</p>
                </div>
                ...
                <p className="text-gray-600 text-lg leading-relaxed mb-8 not-prose bg-gray-50 border-l-4 border-violet-600 p-8 rounded-r-xl">
                    ...
                    <Link href="/geo" className="text-violet-600 font-bold hover:underline">GEO danışmanlığı sayfasına</Link> göz atabilirsiniz.
                </p>
                ...
                <div className="mt-16 border-t border-gray-100 pt-12">
                    ...
                    <ul className="space-y-6 mb-8">
                        <li className="list-none">
                            <Link href="/geo/ai-overviews-nedir" className="inline-flex items-center text-violet-600 hover:underline font-bold group text-lg">
                                <span className="w-2 h-2 rounded-full bg-violet-600 mr-3 group-hover:scale-125 transition-all" />
                                AI Bakışı (AI Overviews) Nedir?
                            </Link>
                            <p className="text-sm text-gray-500 ml-5 mt-1 leading-relaxed max-w-2xl">SERP üstündeki özet bloğunun mekaniği ve AI Modu&apos;ndan farkı.</p>
                        </li>
                        <li className="list-none">
                            ...
                            <p className="text-sm text-gray-500 ml-5 mt-1 leading-relaxed max-w-2xl">Tek sorgunun onlarca alt sorguya bölündüğü mekanizmanın detayı.</p>
                        </li>
                        <li className="list-none">
                            ...
                            <p className="text-sm text-gray-500 ml-5 mt-1 leading-relaxed max-w-2xl">ChatGPT&apos;nin yanıtlarında kaynak gösterilme rehberi.</p>
                        </li>
                        <li className="list-none">
                            ...
                            <p className="text-sm text-gray-500 ml-5 mt-1 leading-relaxed max-w-2xl">Hub-and-spoke içerik kümeleriyle konu otoritesi kazanma.</p>
                        </li>
                    </ul>
