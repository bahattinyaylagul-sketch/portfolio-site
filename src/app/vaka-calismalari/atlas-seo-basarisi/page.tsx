...
export const metadata: Metadata = {
    title: "Atlas Üniversitesi Sürdürülebilir SEO Büyümesi – Bahattin Yaylagül",
    description: "2020'den 2026'ya Atlas Üniversitesi Hastanesi'nin organik grafiğinin ve kelime kazanımlarının detaylı analizi.",
    alternates: {
        canonical: "/vaka-calismalari/atlas-seo-basarisi",
    },
};

export default function AtlasSeoGrowthCaseStudy() {
    return (
            ...
            <div className="pt-32 pb-8 px-6">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <h1 className="text-4xl md:text-5xl font-black text-gray-900 mb-6 tracking-tight">
                        Atlas Üniversitesi: Sürdürülebilir SEO Büyüme Analizi
                    </h1>
                    <p className="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed mb-8">
                        2020'den 2026'ya uzanan, istikrarlı bir stratejiyle 0'dan 185K+ organik trafiğe ve 31K+ sıralanan kelimeye ulaşan büyüme grafiğinin derinlemesine incelemesi.
                    </p>
