            ...
            <div className="max-w-5xl mx-auto px-6">
                ...
                <div className="grid md:grid-cols-3 gap-12 mb-12">
                    ...
                    <div className="md:col-span-1">
                        <Link
                            href="/"
                            className="text-2xl font-bold tracking-widest mb-4 block"
                        >
                            BY.
                        </Link>
                ...
                <div className="border-t border-gray-800 pt-8">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <a
                                href="https://twitter.com/bahattinylgl"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center text-gray-400 hover:bg-gray-700 hover:text-white transition-colors"
                                aria-label="Twitter"
                            ...
                            <a
                                href="https://github.com/bahattinyaylagul"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center text-gray-400 hover:bg-gray-700 hover:text-white transition-colors"
                                aria-label="GitHub"
