                    ...
                    {items.map((item, index) => {
                        ...
                        return (
                            <Wrapper 
                                href={item.link || "#"} 
                                key={index} 
                                className={`${item.col} block h-full ${!isLink ? "cursor-default" : ""}`}
                            >
                                <FadeIn delay={item.delay} className="h-full">
                                    <article className={`h-full min-h-[220px] flex flex-col justify-center p-8 bg-gray-50 rounded-2xl relative overflow-hidden border border-gray-100/50 transition-all duration-300 ${isLink ? "group cursor-pointer hover:border-gray-200 hover:shadow-sm" : ""}`}>
                                        ...
                                        <h3 className={`text-xl font-sans font-bold mb-3 text-foreground transition-colors relative z-10 ${isLink ? "group-hover:text-black" : ""}`}>
                                            {item.title}
                                        </h3>
