...
export default function ArticleFooter({ currentSlug }: { currentSlug: string }) {
    ...
    return (
        <div className="max-w-[1400px] mx-auto px-6 md:px-8 pb-20">
            {/* CTA Banner */}
            <aside className="my-16 p-8 bg-gray-50 border border-gray-100 rounded-3xl flex flex-col md:flex-row items-center justify-between gap-6 md:gap-12 relative overflow-hidden" aria-label="GEO Danışmanlığı Teklifi">
                ...
                <div className="relative z-10 shrink-0 w-full md:w-auto">
                    <Link href="/geo" className="inline-flex items-center justify-center w-full px-8 py-4 bg-gray-900 text-white font-semibold rounded-xl hover:bg-black hover:-translate-y-1 transition-all shadow-md whitespace-nowrap">
