                        ...
                        if (item.link) {
                            ...
                            return (
                                <div key={index} className={\`\${item.col} block h-full\`}>
                                    <FadeIn delay={item.delay} className="h-full">
                                        <article className="h-full min-h-[220px] flex flex-col justify-center p-8 bg-gray-50 rounded-2xl group cursor-default relative overflow-hidden border border-gray-100/50 hover:border-gray-200 hover:shadow-sm transition-all duration-300">
                                            <div className="absolute -right-10 -bottom-10 w-32 h-32 bg-gray-100 rounded-full blur-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                                            <h3 className="text-xl font-sans font-bold mb-3 text-foreground transition-colors relative z-10">
                                                {item.title}
                                            </h3>
                                            <p className="text-sm text-gray-600 leading-relaxed font-sans font-light relative z-10">
                                                {item.desc}
...
console.log('Fixed ServicesBento.tsx for RSC auth bug');
